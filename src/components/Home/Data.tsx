    ...
    <>
      <div className="h-full text-slate-500 ">
        <h1 className="lg:text-7xl md:text-6xl sm:text-6xl text-6xl font-semibold tracking-tight leading-none">
          Aqsa<span className="ahmed">Ahmed</span>
        </h1>
        ...
        <div className="desc">
          <p className="leading-none lg:text-sm md:text-sm sm:text-sm  text-sm tracking-tight lg:max-w-[28vw] sm:max-w-[68vw] max-w-[68vw]">
            Hi, I am Aqsa ahmed. A Front-end developer based in Pakistan. I am
            very passionate and dedicated to my work.
          </p>
        </div>
        <div className=" lg:block md:flex md:items-center md:justify-between">
          <a href="https://wa.me/+923303936146" className="bg-slate-800 flex justify-center items-center lg:gap-2 md:gap-2 sm:gap-1 gap-1 md:text-sm sm:text-sm text-sm lg:py-3 md:py-2 sm:py-2 py-2 md:px-3 sm:px-2 px-2 lg:w-[12.1vw] md:w-[13vw] rounded-lg mt-7 tracking-tighter text-white font-[500]">
            Say Hello
            <svg
      ...
      <div
        className="picSec lg:block lg:ml-24 md:flex sm:flex flex  lg:max-h-[24vw] 
      "
      >
        <div className="lg:-mt-20">
          <img
            src="https://imgs.search.brave.com/HlX8EbDb2pjdCldtzW4ypE6kIZmDSlyu1qBdrt3oWvU/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9zdGF0/aWMudmVjdGVlenku/Y29tL3N5c3RlbS9y/ZXNvdXJjZXMvcHJl/dmlld3MvMDAwLzIy/Ny84NTQvbm9uXzJ4/L2ZlbWFsZS1kZXZl/bG9wZXItdmVjdG9y/LmpwZw"
            alt="Profile Pic"
          />
        </div>
      </div>
